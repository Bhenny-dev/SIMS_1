...
import { getEvents, addEvent, updateEvent, deleteEvent as apiDeleteEvent } from '../services/api.ts';
...
const Events: React.FC = () => {
  ...
  const fetchEvents = async () => {
    ...
    try {
      ...
      if (eventIdParam) {
          const foundEvent = data.find(e => e.id === eventIdParam);
          if (foundEvent) {
