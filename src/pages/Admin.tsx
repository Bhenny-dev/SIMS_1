...
import { getUsers, updateUserRole, register, deleteUser, STORAGE_KEYS, getLeaderboard, getEvents } from '../services/api.ts';
                            ...
                            {filteredUsers.map(user => (
                                <tr key={user.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <button onClick={() => handleRemoveUser(user.id, user.name)} className="text-red-600 hover:text-red-900 dark:text-red-500 dark:hover:text-red-300">
                                            Remove
                                        </button>
                                    </td>
                                </tr>
